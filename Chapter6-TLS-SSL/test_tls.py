# -*- coding: utf-8 -*-
"""
Created on Fri Aug 14 14:28:19 2020

@author: fikirsanat
"""

"""
runfile('C:/Users/fikirsanat/Documents/Network Programming/Chapter6-TLS-SSL/test_tls.py',args='-a ca.crt localhost 1060' ,wdir='C:/Users/fikirsanat/Documents/Network Programming/Chapter6-TLS-SSL')
runfile('C:/Users/fikirsanat/Documents/Network Programming/Chapter6-TLS-SSL/test_tls.py',args='-p TLSv1_1 -a ca.crt localhost 1060' ,wdir='C:/Users/fikirsanat/Documents/Network Programming/Chapter6-TLS-SSL')
"""
...
def describe(ssl_sock, hostname, server=False, debug=False):
    ...
    #cipher() şifrenin adını döndürür
    cipher, version, bits = ssl_sock.cipher()
    #compression() kullanımda olan sıkıştırma algoritmasının adını döndürür
...
if __name__ == '__main__':
    ...
    """
    YUKARIDAKI ISLEMLER YERINE KENDI SIPESIFIK AYARLAMALARINIZI YAPMAK ISTIYORSANIZ
    ...
    BU SECENEKLERI DESTEKLEYEMEYEN HERHANGI BIR ISTEMCI BAGLANMAYA CALISTIGINDA
    BASARISIZ OLACAKTIR
