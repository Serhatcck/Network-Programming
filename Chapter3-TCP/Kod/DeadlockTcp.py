"""
BU KOD KISA BOYUTLU VERİLER İÇİN ÇALIŞSA BİLE (1024 BYTE)
BÜYÜK BOYUTLU VERİLERDE ARA BELLEK DOLUMUNA NEDEN OLUR VE KOD DURAKLAMAK ZORUNDA KALIR
...
def client(host,port,bytecount):
    ...
    message = b'capitalize this! capit'  # 16-byte message to repeat over and over
